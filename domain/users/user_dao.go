...
const (
	...
	queryGetAllUsers               = "SELECT id, email, username, display_name, biography, COALESCE(to_char(birthday, 'YYYY-MM-DD'), '') AS birthday, profile_pic, points, to_char(date_created, 'YYYY-MM-DD') AS date_created FROM user_db.users"
